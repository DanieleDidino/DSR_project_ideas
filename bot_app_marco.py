...
query_engine_default = default_engine(
    folder_with_index, qa_template, number_top_results
)
...
with st.sidebar:
    ...
    ### TODO: function showing the files in store
...
if use_user_docs:
    if uploaded_file:
        query_engine_user = engine_from_upload(
            folder_user_uploaded_files, qa_template, number_top_results
        )
