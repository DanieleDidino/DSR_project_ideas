...
search = GoogleSearchAPIWrapper(google_api_key="AIzaSyCaMdgVAu6iFwM76uTysJv6dunOC2QcClY", google_cse_id="34bb1f0fa0eee4bd3")
...
# works talks about soures but does not provide them - map_reduce, combined custom prompt
class QAChain():
    def __init__(self):
...
class ToolChainAgent():
    ...
    def run(self, user_input):
        """Agent runs query with his tools: 
